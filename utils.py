...
def process_image(uploaded_file):
    ...
    milk_entries = []
    total_milk = 0.0
    debug_tokens = []  # collect tokens for debugging
    ...
    for line in text.split("\n"):
        ...
        tokens = re.findall(r"[0-9a-zA-Z]+", line)
        debug_tokens.extend(tokens)  # keep track
    ...
    # Pricing logic
    rate = 70   # as per your bill
    extras = 150
    grand_total = (total_milk * rate) + extras

    # Return debug info as well
    return text, milk_entries, total_milk, grand_total, debug_tokens
